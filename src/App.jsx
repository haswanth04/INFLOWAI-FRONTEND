...
function App() {
  ...
  return (
    ...
    >
      {/* Header */}
      <header
        className={`flex items-center justify-between px-6 py-4 border-b backdrop-blur-sm sticky top-0 z-10 transition-colors duration-300 ${
          isDark
      ...
      <div className="flex-1 overflow-y-auto">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full px-4">
            ...
            >
              Ask me anything and I'll provide you with detailed, helpful
              responses.
            </p>
          </div>
        ) : (
          <div className="max-w-3xl mx-auto px-4 py-6">
            {messages.map((message, index) => (
              ...
              >
                ...
                <div
                  className={`flex-1 ${
                    message.type === "user" ? "max-w-xs" : "max-w-none"
                  }`}
                >
                  <div
      ...
      >
        <div className="max-w-3xl mx-auto px-4 py-4">
          <div
            className={`relative rounded-2xl border focus-within:border-blue-300 focus-within:ring-1 focus-within:ring-blue-300 transition-all duration-200 ${
              isDark
          ...
          >
            InfoFlow AI can make mistakes. Consider checking important
            information.
          </p>
        </div>
      </div>
